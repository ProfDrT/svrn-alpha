    ...
    <div style={{ padding: isMobile ? "60px 20px 80px" : "80px 60px 100px" }}>
      <ArticleLayout>
        ...
        <div style={{ marginBottom: 60 }}>
          ...
          <p style={{ ...TYPO.body, fontSize: isMobile ? 16 : 18 }}>
            For over a decade, Prof. Dr. Tobias Blask researched digital transformation in Organizations. The patterns were consistent and frustrating: institutions invested billions in AI technology, hired data scientists, licensed platforms — and achieved almost nothing. The failure rate hovered around 70%, year after year.
          </p>
          <p style={{ ...TYPO.body, fontSize: isMobile ? 16 : 18 }}>
