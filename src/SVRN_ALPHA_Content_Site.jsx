        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontSize: 16, color: C.textMuted, lineHeight: 1.7, marginBottom: 32, fontFamily: sans }}>
              ...
              your only defensible asset is your proprietary data structure."
            </p>
          ...
          <div style={{
            ...
            <div style={{ padding: isMobile ? "20px" : "24px 32px", fontFamily: mono, fontSize: 13, lineHeight: 1.6 }}>
              ...
              <div style={{ paddingLeft: 20, color: C.textSoft }}>
                ...
                Data Sovereignty: <span style={{ color: C.success }}>[100% SECURE]</span>
              </div>
          ...
          <div style={{
            ...
            {[
              ...
              },
              {
                ...
                desc: "Human-in-the-Loop. Sovereign architecture keeping proprietary data within the fortress.",
                detail: "PROTOCOL: SECURE",
              },
            ].map((p, i) => (
              <div
                key={i}
              ...
              >
                ...
                <p style={{
                  fontSize: 14, color: C.textSoft, lineHeight: 1.7, margin: "0 0 24px", fontFamily: sans
                }}>{p.desc}</p>
        ...
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          ...
          <div style={{
            ...
            {[
              ...
              { label: "GDPR Sovereignty", status: "ENFORCED" },
              { label: "Private Cloud Residency", status: "LOCAL" },
              { label: "Human-in-the-Loop", status: "LOCKED" },
            ].map((item, i) => (
              <div key={i} style={{
                display: "flex", justifyContent: "space-between", alignItems: "center",
                ...
                <span style={{
                  fontFamily: mono, fontSize: 12, fontWeight: 700,
                  color: item.status === "LOCKED" || item.status === "ENFORCED" ? C.accent : C.primary,
                }}>[{item.status}]</span>
              </div>
            ))}
          </div>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{
            ...
            margin: "0 auto 48px", lineHeight: 1.6, fontFamily: sans
          }}>
